...
void print()
{
    ...
    output1.print("All Groups having their members with their final width and height:  ");
    output1.println("");
    output1.println("");
    ...
    output1.println("");
    output1.println("Number of Inner extra spaces: " + innerextraspace);
    output1.println("Number of Outer extra spaces: " + outerextraspace);
    output1.println("Area of plus shape floor plan: " + totalarea);
    output1.println("Area of circulations and terraces: " + (totalarea - area_rects));
  
    output1.println("");
    output1.println("Adjacency Matrix");
    output1.println("");
    ...
    output1.println("Degree of all rooms");
    ...
    output1.println("");
    output1.println("Eigenvalues of adjacency matrix");
    ...
    output1.println("");
    output1.println("");
    output1.println("Characteristic Polynomial of Adjacency Matrix");
    for (int i1 = 0; i1 < n / 2; i1 = i1 + 1) {
	if (i1 > 0)
    ...
    output1.println("");
    output1.println("Distance Matrix");
    output1.println("");
    for (int i = 0; i < n/2+1; i = i + 1) {
	output1.print(rectangles[i] + "   ");
    }
    ...
    output1.println("");
    output1.println("Shortest path between all pair of rooms");
    output1.println("");
    ...
    output1.println("");
    output1.println("All cut vertices of obtained graph");
    ...
    output1.println(" ");
    output1.println(" ");
    output1.println("All pair cut vertices of obtained graph");
    ...
    output1.println(" ");
    output1.println(" ");
    output1.println("Eccentricity of all rooms");
    ...
    output1.println("");
    output1.println("");
    output1.println("First order moment of all rooms");
    for (int j4 = 1; j4 < n / 2 + 1; j4 = j4 + 1) {
    ...
    output1.println("");
    output1.println("First order moment of all rooms(having surface one)");
    for (int j4 = 1; j4 < n / 2 + 1; j4 = j4 + 1) {
    ...
    output1.println("");
    output1.println("");
    output1.println("Moment of Inertia of all rooms");
    for (int j4 = 1; j4 < n / 2 + 1; j4 = j4 + 1) {
    ...
    output1.println("");
    output1.println("Moment of Inertia of all rooms(having surface one)");
    for (int j4 = 1; j4 < n / 2 + 1; j4 = j4 + 1) {
