...
//this function obtains adjacency matrix and degree of all rooms
...
void adjacencymatrix()
{
	...
	for (int j2 = 0; j2 < nbrofpairs; j2 = j2 + 1) {
		...
		//ith room is adjacent to second member of corresponding adjacency pair
	    }
	    if (i == adjacentpair2[j2]) {	//when i is equal to 2nd member of any adjacency pair
		adjacencymatrix[i][adjacentpair1[j2]] = 1;
		//then ith room is adjacent to 1st member of corresponding adjacency pair
	    }
	}
    }
