...
void plusshape()
{
   ...
   // of groups and then area of plus shaped frame
    ...
    x = 180;
    y = 190; //intial position on x-axis and y-axis                      
 
   // this is for drawing index on the screen
    rect(x + r5[10], y + r5[9] + r5[11] + 10, 12, 12);
    fill(250);
    rect(x + r5[10], y + r5[9] + r5[11] + 30, 12, 12);
    fill(75);
    rect(x + r5[10], y + r5[9] + r5[11] + 50, 12, 12);
 
    fill(10, 0, 0);
    PFont myFont = createFont("Times", 14);
    textFont(myFont);
    text("- Rectangles", x + r5[10] + 22, y + r5[9] + r5[11] + 21);
    text("- Inner extra space", x + r5[10] + 22, y + r5[9] + r5[11] + 41);
    text("- Outer extra space", x + r5[10] + 22, y + r5[9] + r5[11] + 60);
    noFill();
...
void shape1()
{
    ...
    //this is for the second room of any group
  ...
  //calculating initial value of height of rectangular frame
	...
	if (j % 4 == 1) {	//interchange of length and height of 3rd, 7th, 11th and so on rectangles
		...
		//if height of this room is > sum of heights calculated above then 
	...
	if (j % 4 == 2) {	//interchange of length and height of 4th, 8th, 12th and so on rectangles
		...
		//if length of this room > sum of lengths calculated above then 
		//it save length of this room as sum of lengths calculated above
...
void shape1_1()
{
 ...
 A_original[0] = abs(length[members_grp[k3][1]] - length[members_grp[k3][0]]);
    H_frame[t1] = height[members_grp[k3][0]];	//it saves height of first room as H_frame[0]
    t1++;
 
 
    if (length[members_grp[k3][1]] > length[members_grp[k3][0]]) {
	//bigger length among 1st and 2nd room is saved as L_frame[0]
	L_frame[t5] = length[members_grp[k3][1]];
	t5++;
    } else {
	L_frame[t5] = length[members_grp[k3][0]];
...
void extra1_2(int p1, int p2, int p3, int p4)
{
    ...
    if (r5[1] > r5[0]) {
	//if length of group2 is greater group1 then it draws a room below to group1
	rect(x + p5 + r20 + k15, y + r5[0] - r7, r5[2], r5[1] - r5[0]);
	outerextraspace++;
    }
 
    if (r5[1] < r5[0]) {
	//if length of group2 is smaller group1 then it draws a room below to group2
...
void extra1_3(int p1, int p2, int p3)
{
   ...
   float r8 = 0, r9 = 0, r22 = 0, r23 = 0, r24 = 0;
	...
	if (r23 < r22 && r22 > r24) {	//if length of group1 is > group3 and group5
	    //we draw a room above group1 parallel to group3
	...
	if (r23 > r22 && r23 > r24) {	//if length of group3 > group1 and group5
	    //draw a room below group3 parallel to group1 
	    if (r5[1] > r5[0]) {
	...
	if (r23 < r24 && r22 < r24) {	//if length of group5 > group1 and group3
		...
		outerextraspace++;	//increase number of extra spaces by one
		rect(x + r23 - r8, y + r9 - r5[5] + k15, r22 - r23, r5[5]);
		//draw a room above group1 parallel to group3
		//then a big room above group5 parallel to group1 and group3
	...
	if (r23 < r24 && r22 < r24) {	//if length of group5 > group1 and group3
		...
		if (r5[1] >= r5[0]) {	//draw a room below group3 parallel to group1
		    rect(x - r8 + r22, y + r9 + k15, r23 - r22, r5[1]);
		}
		//draw a big room above group5 parallel to group1 and group3
		if (r5[1] < r5[0]) {
		    rect(x - r8 + r22, y + r9 + k15, r23 - r22, r5[0]);
		}
	...
	if (r23 == r22 && r22 < r24) {	//if length of group5 > group1 and group3
	    ...
	    //then draw a big room above group5 parallel to group1 and group3 
...
void extra1_4(int p1, int p2)
{
   float r10 = 0, r11 = 0, r12 = 0, r13 = 0, r25 = 0, r26 = 0, r27 = 0;
	...
	//draw a big room below group1 and group2 
	rect(x - r10 - r12 - r5[3], y + r13 - r11, r12 + r5[3], r5[7] - r13);
    } else {			//draw a room below group4 
...
void extra1_5(int p1, int p2)
{
	...
	//draws a room below group 1 parallel to group5 
	fill(75);
...
void shape1_2()
{
    ...
    //this prints number of every first room of any group
    ...
    //this draws frist room of any group
    rect(x, y, length[members_grp[k3][0]], height[members_grp[k3][0]]);
 
    if (no_rects > 1) {
	//this prints number of every second room of any group
	...
	//this is to draw 2nd room of any group
	if (length[members_grp[k3][1]] < length[members_grp[k3][0]]) {	//if length of 2nd room < 1st rectangle
	    rect(x, y - height[members_grp[k3][1]], length[members_grp[k3][1]], height[members_grp[k3][1]]);
	    //draws second room of any group
	    fill(250);
	    rect(x + length[members_grp[k3][1]], y - height[members_grp[k3][1]], A_original[0], height[members_grp[k3][1]]);
	    //draws a room above first room of length A_original[0] and height of 2nd rectangle
	    noFill();
	} else {
	    rect(x, y - height[members_grp[k3][1]], length[members_grp[k3][1]], height[members_grp[k3][1]]);
	    //this draws second room of any group 
	    fill(250);
	    rect(x + length[members_grp[k3][0]], y, A_original[0], height[members_grp[k3][0]]);
	    //draws a room below second room of length A_original[0] and height of 1st rectangle
	    noFill();
	}
    ...
    if (length[members_grp[k3][1]] > length[members_grp[k3][0]]) {
	//bigger length among first and second room is saved as L_frame[0]
	...
	if (j % 4 == 1) {	// it draws 3rd, 7th, 11th and so on rectangles
		...
		//draws room of height H_frame[] and length of given rectangle.
	    ...
	    if (height[members_grp[k3][i1]] > (H_frame[x2 - 1])) {
		fill(250);
		//if height of this room is greater than height of rectangular frame calculated above then 
		rect(x - L_frame[x1 - 1], y + H_frame[x2 - 1], L_frame[x1 - 1], height[members_grp[k3][i1]] - H_frame[x2 - 1]);
		//it draws a room just below to 2nd last rectangle
		noFill();
	    }
 
	    if (height[members_grp[k3][i1]] > H_frame[x2 - 1]) {
		//if height of this room is greater than sum of heights calculated above
		H_frame[x2 - 1] = height[members_grp[k3][i1]];
		//then it save height of this room as height of rectangular frame calculated above
	    }
	...
	if (j % 4 == 2) {	//draws 4th, 8th, 12th and so on rectangles
		...
		//it draws a room of length L_frame[] and height of given rectangle
		fill(250);
		...
		//it draws a room just parallel to last rectangle
		noFill();
	    }
 
	    if (length[members_grp[k3][i1]] > L_frame[x1 - 1])
		L_frame[x1 - 1] = length[members_grp[k3][i1]];
	    //save length of this room as sum of lengths calculated above
	}
...
void shape2_2()
{
    ...
    //this draws first room of any group
    rect(x, y, length[members_grp[k3][0]], height[members_grp[k3][0]]);
 
    if (no_rects > 1) {
	//this print number of every second room of any group
	...
	if (length[members_grp[k3][1]] < length[members_grp[k3][0]]) {
	    //if length of second room is smaller than first rectangle
	    ...
	    //it draws a room above first room of length A_original[0] and height of 2nd rectangle
	    noFill();
	} else {
	    rect(x, y + height[members_grp[k3][0]], length[members_grp[k3][1]], height[members_grp[k3][1]]);
	    //this draws second room of any group 
	    fill(250);
	    rect(x + length[members_grp[k3][0]], y, A_original[0], height[members_grp[k3][0]]);
	    //it draws a room below second room of A_original[0] and height of 1st rectangle
	    noFill();
	}
    ...
    H_frame[0] = height[members_grp[k3][0]];	//it saves height of first room as H_frame[0]
	...
	if (j % 4 == 1) {
		...
		fill(250);
		rect(x + length[members_grp[k3][i1]], y + H_frame[x2 - 1], L_frame[x1 - 1], height[members_grp[k3][i1]] - H_frame[x2 - 1]);
		//it draws a room i.e. extra space just below to 2nd last rectangle
		noFill();
	    }
 
	    if (height[members_grp[k3][i1]] > H_frame[x2 - 1]) {
		H_frame[x2 - 1] = height[members_grp[k3][i1]];	//if height of this room is greater than sum of heights calculated above 
		//then it save height of this room as sum of heights calculated above
	    }
	...
	if (j % 4 == 3) {
		...
		fill(250);
		rect(x - L_frame[x1 - 1], y + H_frame[x2 - 1], L_frame[x1 - 1], height[members_grp[k3][i1]] - H_frame[x2 - 1]);
		//it draws a room just below to last rectangle
		noFill();
	    }
	...
	if (j % 4 == 0) {
		...
		fill(250);
		rect(x + L_frame[x1 - 1], y - H_frame[x2 - 1], length[members_grp[k3][i1]] - L_frame[x1 - 1], H_frame[x2 - 1]);
		//it draws a room just parallel to 2nd and 3rd last rectangles 
		noFill();
	    }
...
void shape3_2()
{
    ...
    //this print number of every first room of any group 
    PFont myFont = createFont("Times", 12);
    textFont(myFont);
    fill(255, 0, 0);
    text(rectangles[members_grp1[k3][0]], x + (length[members_grp[k3][0]] / 4), y + 8 + (height[members_grp[k3][0]] / 2));
